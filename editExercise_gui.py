...
class EditExerciseGUI():
    def __init__(self, master, userObject, exerciseObject, exerciseName, allExercises):
        self.master = master
        ...
        self.setsEntry = None
        self.repsEntry = None
        self.maxWeightEntry = None
        self.originalWeightEntry = None
        self.editExercise_controllerObject = editExercise_controller.EditExerciseController(self.userObject, self.exerciseObject, allExercises)
    ...
    * Post0. main frame for edit exercise is created
    ...
    def createMainFrame(self): 
        title = Label(self.master, text="Edit Exercise",font=("Fixedsys", 40, "bold"),height = 2, width = 20,borderwidth=0, background='#3E3C3C', foreground='white').grid(row=1,column=0, columnspan=2 )
        
        exerciseName = Label(self.master, text=self.exerciseNameString, font=("Fixedsys", 20, "bold"),height = 2, width = 35,borderwidth=1, background='lightgray', foreground='black').grid(row=2,column=0, columnspan=2) 

        sets = Label(self.master, text="Sets",font=("Fixedsys", 15),height = 2, width = 20,borderwidth=0, background='#3E3C3C', foreground='white').grid(row=3,column=0, sticky='w', pady=5)
        ...
        reps = Label(self.master, text="Reps",font=("Fixedsys", 15),height = 2, width = 20,borderwidth=0, background='#3E3C3C', foreground='white').grid(row=4,column=0, sticky='w',pady=5)
        ...
        maxWeight = Label(self.master, text="Max Weight",font=("Fixedsys", 15),height = 2, width = 20,borderwidth=0, background='#3E3C3C', foreground='white').grid(row=5,column=0, sticky='w',pady=5)
        ...
        originalWeight = Label(self.master, text="Original Weight",font=("Fixedsys", 15),height = 2, width = 20,borderwidth=0, background='#3E3C3C', foreground='white').grid(row=6,column=0, sticky='w',pady=5)
        ...
        saveButton = Button(self.master,text="Save", borderwidth=0, command=lambda: self.handleSaveInformationEvent(),  highlightthickness=0).grid(row = 7,column=1, pady=5,padx=5,)
        cancelButton = Button(self.master,text="Cancel", borderwidth=0,  highlightthickness=0, command=lambda: self.closeWindow()).grid(row = 7,column=1, pady=5, padx=5,sticky="e")
