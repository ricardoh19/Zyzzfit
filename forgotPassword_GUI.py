...
class ForgotPasswordGUI():
    def __init__(self, master):
        ...
        self.reenterPasswordEntry = None
        self.securityQuestionEntry = None
        self.signUpcredentials = None
    ...
    * Post0. main frame for sign up is created
    ...
    def createMainFrame(self): 
        ...
        exitButton = Button(self.master,text="Close",command=lambda: self.handleCloseEvent(), borderwidth=0, highlightthickness=0).grid(row = 5,column=0, sticky='e', padx=60)
        ResetPasswordButton = Button(self.master,text="Reset Password",command=lambda: self.handleForgotPasswordEvent(), borderwidth=0,highlightthickness=0).grid(row = 5,column=0, sticky='w',padx=60)
    ...
    * Post0. frame with SignUp, Username, and Password entries is implemented for sign up 
    ...
    def createSignUpUsernamePasswordFrame(self):
        ...
        usernameLabel = Label( self.signUpcredentials, text="Enter a Username",font='Fixedsys 13 bold',borderwidth=0, background="LightGray").grid(row = 3,column=0,padx=50 ,pady=35,ipadx=5,ipady=5, sticky="nw")
        passwordLabel = Label( self.signUpcredentials, text="Enter New Password",font='Fixedsys 13 bold',borderwidth=0, background="LightGray").grid(row=3, column=0,padx=50,pady=25, ipadx=5,ipady=5,sticky="w")
        reenterPasswordLabel = Label( self.signUpcredentials, text="Reenter the New Password",font='Fixedsys 13 bold',borderwidth=0, background="LightGray").grid(row=3, column=0,padx=50,pady=25, ipadx=3,ipady=5,sticky="sw")
    ...
    * Post0. frame with the security question for sign up is created
    ...
    def createSecurityQuestionFrame(self):
        ...
        buttons= Frame(self.master, width = 600, height = 150, borderwidth=0, background="LightGray").grid(row = 4,column=0,padx=20, pady=5)
        securityQuestionLabel = Label( self.signUpcredentials, text="Security Question: What is your favorite food?",font='Fixedsys 13 bold',borderwidth=0, background="LightGray").grid(row=4, column=0,padx=15,pady=15, ipadx=1,ipady=1,stick="n")
