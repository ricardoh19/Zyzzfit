...
class SignUpGUI():
    ...
    * Post0. main frame for sign up is created
    ...
    def createMainFrame(self): 
        ...
        signUpButton = Button(self.master,text="Sign Up",command=lambda: self.handleSignUpEvent(), borderwidth=0,highlightthickness=0).grid(row = 5,column=0, sticky='w',padx=60)
    ...
    * Post0. frame with SignUp, Username, and Password entries is implemented for sign up 
    ...
    def createSignUpUsernamePasswordFrame(self):
        ...
        passwordLabel = Label( self.signUpcredentials, text="Enter a Password",font='Fixedsys 13 bold',borderwidth=0, background="LightGray").grid(row=3, column=0,padx=50,pady=25, ipadx=5,ipady=5,sticky="w")
        reenterPasswordLabel = Label( self.signUpcredentials, text="Reenter the Password",font='Fixedsys 13 bold',borderwidth=0, background="LightGray").grid(row=3, column=0,padx=50,pady=25, ipadx=3,ipady=5,sticky="sw")
